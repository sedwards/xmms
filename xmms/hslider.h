...
{
	Widget hs_widget;
	gint hs_knob_nx, hs_knob_ny, hs_knob_px, hs_knob_py, hs_knob_width, hs_knob_height;
	gint hs_frame_height, hs_frame_offset, hs_frame;
	gint hs_min, hs_max, hs_position;
	gboolean hs_pressed;
	gint hs_pressed_x;
