...
void create_skin_window(void)
{
	...
	gtk_signal_connect(G_OBJECT(skinwin_list), "select_row", GTK_SIGNAL_FUNC(change_skin_event), NULL);
	...
	gtk_signal_connect(G_OBJECT(checkbox), "toggled", GTK_SIGNAL_FUNC(enable_random_skin_event), NULL);
