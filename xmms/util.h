...
void util_item_factory_popup(GtkUIManager * ifactory, guint x, guint y, guint mouse_button, guint32 time);
void util_item_factory_popup_with_data(GtkUIManager * ifactory, gpointer data, GDestroyNotify destroy, guint x, guint y, guint mouse_button, guint32 time);
